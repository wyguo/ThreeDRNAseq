...
cat('  \nBlocks ( n=',length(unique(samples_new$block)),'):',paste0(unique(samples_new$block),collapse = ', '))
...
```{r}
knitr::include_graphics(system.file("DDD_definition.png", package = "ThreeDRNAseq"))
```
...
```{r,echo=FALSE, out.width = '100%',fig.cap=('DE genes updown regulation numbers.')}
if(!file.exists('figure/DE genes updown regulation numbers.png')){
  cat('The file "figure/DE genes updown regulation numbers.png" is not in the "figure" folder of working directory.')
} else {
  knitr::include_graphics("figure/DE genes updown regulation numbers.png")
}
```

```{r,echo=FALSE, out.width = '100%',fig.cap=('DAS genes updown regulation numbers.')}
if(!file.exists('figure/DAS genes updown regulation numbers.png')){
  cat('The file "figure/DAS genes updown regulation numbers.png" is not in the "figure" folder of working directory.')
} else {
  knitr::include_graphics("figure/DAS genes updown regulation numbers.png")
}
```

```{r,echo=FALSE, out.width = '100%',fig.cap=('DE transcripts updown regulation numbers.')}
if(!file.exists('figure/DE transcripts updown regulation numbers.png')){
  cat('The file "figure/DE transcripts updown regulation numbers.png" is not in the "figure" folder of working directory.')
} else {
  knitr::include_graphics("figure/DE transcripts updown regulation numbers.png")
}
```

```{r,echo=FALSE, out.width = '100%',fig.cap=('DTU transcripts updown regulation numbers.')}
if(!file.exists('figure/DTU transcripts updown regulation numbers.png')){
  cat('The file "figure/DTU transcripts updown regulation numbers.png" is not in the "figure" folder of working directory.')
} else {
