...
heatmap.g <- eventReactive(input$plot.heatmap,{
  if(is.null(heatmap.targets()))
    return(NULL)
  showNotification('Plotting heatmap, please waiting ...',
                   ...
                   duration = NULL,id = 'heatmap_message')
...
output$heatmap.plot.panel <- renderPlot({
  ...
  removeNotification(id = 'heatmap_message')
...
##download the plot
# save_heatmap_flag <- reactiveValues(download_flag = 0)
# output$save_heatmap <- downloadHandler(  # downloads data
#   filename = function() {
#     paste0('Heatmap ', input$heatmap.target.type,'.png')
#   },
#   content = function(file) {
#     save_heatmap_flag$download_flag <- save_heatmap_flag$download_flag + 1
#     
#     png(file,
...
observeEvent(input$save_heatmap,{
  ...
  #   return(NULL)
  showNotification('Saving heatmap, please waiting ...',
                   # action = HTML("<span style='font-size:50px;'>&#9786;</span> <i style='font-size:25px;' class='fas fa-dizzy'></i>"),
                   action = HTML("<i style='font-size:35px;' class='fas fa-dizzy'> ... ...</i>"),
                   duration = NULL,id = 'save_heatmap_message')
  ...
  removeNotification(id = 'save_heatmap_message')
  showmessage('Done!!!',action = HTML("<i style='font-size:35px;' class='fas fa-smile-wink'></i>"))
...
observeEvent(input$make.multiple.plot,{
  ...
  showNotification('Making profile plot ...',
                   # action = HTML("<span style='font-size:50px;'>&#9786;</span> <i style='font-size:25px;' class='fas fa-dizzy'></i>"),
                   action = HTML("<i style='font-size:35px;' class='fas fa-dizzy'> ... ...</i>"),
  ...
  removeNotification(id = 'profile_plot_message')
  showmessage('Done!!!',action = HTML("<i style='font-size:35px;' class='fas fa-smile-wink'></i>"))
})
