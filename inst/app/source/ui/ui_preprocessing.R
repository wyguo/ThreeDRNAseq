...
tabItem('preprocessing',
        ...
        fluidRow(
          column(width = 7,offset = 0, 
                 ...
                 box(title = 'Step 1: Filter low expressed transcripts and genes',
                     ...
                     br(),
                     hr(),
                     HTML('<strong>Note:</strong> <ul> 
                            <li>In many publications, the CPM cut-off is set to 1 CPM and then varing the number of samples to cut. </li>
                            <li>An expressed transcript must have &#x2265 <i>n</i> samples &#x2265 <i>m</i> CPM (Count Per Million reads) expression.</li>
        ...
        fluidRow(
          ...
          column(width = 9,
                 ...
                 column(width = 12,
                        ...
                        actionButton(inputId = 'save_pca_plot',label = 'Save',
                                     icon = icon('download',lib = 'font-awesome'),
                        ...
                        actionButton(inputId = 'save_pca_plot_view',label = 'View saved plot',
                                     ...
                                     style="color: #fff; background-color: #428bca; border-color: #2e6da4; 
                                     float: left; margin-top: 25px; margin-left: 25px"),
                        bsTooltip(id = "save_pca_plot_view",
                                  title = "Preview saved plots to correct width and height.",
                                  placement = "bottom", options = list(container = "body"))
                        )
          )
        ...
        column(width = 9,
               ...
               bsTooltip(id = "save_pca_br_plot_view",
                         title = "Preview saved plots to correct width and height.",
                         placement = "bottom", options = list(container = "body")),
               br(),
               br(),
        ...
        fluidRow(
          column(width = 3,
                 box(title = 'Step 4: Data normalization',width = 13,
                     ...
                     actionButton('run_norm','Run and plot distribution',icon("send outline icon",lib = 'font-awesome'),
                                  style="color: #fff; background-color: #428bca; border-color: #2e6da4"),
          ...
          column(width = 9,
                 ...
                 actionButton(inputId = 'save_dist_plot_view',label = 'View saved plot',
                              ...
                              style="color: #fff; background-color: #428bca; border-color: #2e6da4; 
                              float: left; margin-top: 25px; margin-left: 25px"),
                 bsTooltip(id = "save_dist_plot_view",
                           title = "Preview saved plots to correct width and height.",
                           placement = "bottom", options = list(container = "body")),
                 br(),
                 br(),
